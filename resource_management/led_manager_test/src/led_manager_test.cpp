...
class LedManager : public resource_management::ResourceManager<led_manager_msgs::StateMachineRegister, led_manager_msgs::StateMachineExtract, led_manager_msgs::Color, led_manager_msgs::OnOff>
{
public:
  LedManager(const ros::NodeHandlePtr& nh, std::vector<std::string>& plugins) : ResourceManager(std::move(nh), {"emotion", "tagada", "switch"}, plugins)
  {
